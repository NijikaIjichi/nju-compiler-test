...
help(){
  echo "Usage: $0 [-r parser] [-e extend] [-l lab] [-ac] [-t timeout]"
  ...
  echo "t: time limit for compile one test case, default 10s"
  if ! [ -z $1 ]
  then
